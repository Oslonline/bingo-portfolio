        ...
        <section className="flex w-full flex-col items-center gap-20 py-10 pt-20 md:flex-row-reverse md:py-24">
            <div className="flex items-center justify-center md:w-1/3">
                <div className="w-3/6 md:h-2/5 md:w-3/5">
                    <img id="main-img" src={MainImg} alt="Main image illustrating the homepage (pinguin using a computer)" className="hidden border-8 border-transparent shadow-mlight dark:shadow-mdark md:block" />
                    <img id="main-img" src={MainImg} alt="Main image illustrating the homepage (pinguin using a computer)" className="border-8 border-transparent shadow-mlightphone dark:shadow-mdarkphone md:hidden" />
                </div>
            </div>
            <div className="flex flex-col gap-12 px-10 md:w-2/3 md:pl-24">
                ...
                <div className="flex flex-col gap-2 text-gray-600 dark:text-gray-200">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <p>
                            Currently working at <a href="https://radiofrance.com" aria-label="Check the website of my employer, RadioFrance" className="font-semibold dark:text-gray-100 underline dark:hover:text-gray-300 hover:text-gray-800">Radio France</a>
                        </p>
                    </div>
                </div>
